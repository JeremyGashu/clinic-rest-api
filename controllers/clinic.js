...
exports.add_payment = (req, res) => {
    ...
    if(authToken) {
        ...
        if(billNo && patientName && doctor && charges && vat && total) {
            ...
            res.status(400).json({error : true, message : 'billNo, patientName, doctor, charges, vat, total should be provided.'})
        }
...
exports.add_appointment = (req, res) => {
    ...
    if(authToken) {
        ...
        if(name && email && date && visitTime && injury, doctor) {
            ...
            res.status(400).json({error : true, message : 'name, doctor, email, date, visitTime, doctor,injury should be provided.'})
        }
...
exports.add_patient = (req, res) => {
    ...
    if(authToken) {
        ...
        if(name && id && age && address && phoneNo && status) {
            ...
            res.status(400).json({error : true, message : 'name, id, age, address, phoneNo, status should be provided.'})
        }
